...
namespace DrawingStuff
{
    public class VertexDeclaration
    {
        ...
        public readonly static VertexDeclaration ColoredVertex = new VertexDeclaration(
        ...
        public static VertexDeclaration TexturedVertex = 
            new VertexDeclaration(new VertexAttribute[3]
            {    
